<x-app-layout title="Tambah Barang Baku">
            ...
            <div class="mt-4 shadow card">
                ...
                <div class="card-body">
                    <form action="{{ route('produk.update',$produk->kode_produk) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <textarea class="d-none bahanBaku-input" name="bahanBaku">{{ $produk->bahan_baku }}</textarea>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3 form-group">
                                    ...
                                    <x-text-input for="kode_produk" type="text" name="kode_produk" :value="$produk->kode_produk" readonly />
                                    <x-input-error record="kode_produk" />
                                </div>
                                <div class="mb-3 form-group">
                                    <x-input-label for="nama" value="Nama Produk" />
                                    <x-text-input for="nama" type="text" name="nama" :value="old('nama') ?? $produk->nama" autofocus />
                                    <x-input-error record="nama" />
                                </div>
                                <div class="mb-3 form-group">
                                    <x-input-label for="deskripsi" value="Deskripsi" />
                                    <textarea name="deskripsi" rows="10" class="form-control">{{ old('deskripsi') ?? $produk->deskripsi }}</textarea>
                                ...
                                <div class="mb-3 form-group">
                                    ...
                                    <div class="text-center col-6 col-md-3">
                                        @if ($produk->foto)
                                        <img src="{{ asset('produk_photo/'.$produk->foto) }}" alt="..." class="crop-img" id="imgPreview" width="300px"/>
                                        @else
                                            <img src="{{ asset('produk/default.jpg') }}" alt="..." class="crop-img" id="imgPreview" width="300px"/>
                                        @endif
                                    </div>
                                    <div class="mt-3">
                                        <div class="mb-3 form-group">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="simple-select2">Bahan Baku</label>
                                    <select class="form-control select2 @if($errors->has('bahanBaku')) is-invalid @endif" id="simple-select2" name="bahan_baku">
                                        <option value="0" selected>...</option>
                                        @foreach ($bahanBaku as $bahan)
                                        <option value="{{ $bahan->slug }}" @if ($bahan->slug == $produk->slug) selected @endif>
                                            <div class="col">
                                ...
                                <div class="mb-3 form-group">
                                    ...
                                    <div class="mb-3 input-group">
                                        ...
                                        <x-text-input for="harga_beli" type="text" name="harga_beli" class="harga_beli" :value="old('harga_beli') ?? currency_IDR($produk->harga_beli)" readonly />
                                ...
                                <div class="mb-3 form-group">
                                    ...
                                    <div class="mb-3 input-group">
                                        ...
                                        <x-text-input for="harga_jual" id="format-rupiah" type="text" name="harga_jual" :value="old('harga_jual') ?? currency_IDR($produk->harga_jual)" />
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    {{-- <div class="row">
                        ...
                        {{-- <div class="col">
                            <div class="form-group">
                                <x-input-label for="stok_bahan" value="Stok" />
                                <x-text-input for="stok_bahan" class="stok_bahan" type="text" name="stok_bahan" disabled />
                            </div>
                        </div>
                    </div> --}}
                    <hr class="mt-0" />
                    <div class="mt-1 form-group">
                        ...
                        <x-text-input for="jumlah" type="number" name="jumlah" class="jumlah" required/>
    ...
    <script>
        $(document).ready(function () {
            var bahanBaku = [];
            var no = 0;
            bahanBaku = jQuery.parseJSON($('.bahanBaku-input').val());
            bahanBaku["total"] = splitHarga($('.harga_beli').val());
            loadTabel();
            ...
            $("#simpan_bahan_baku").on("click", function () {
                ...
                // Jika jumlah tidak sama dengan 0
                if (jumlahDiminta != "") {
                    if (jumlahDiminta != "0") {
